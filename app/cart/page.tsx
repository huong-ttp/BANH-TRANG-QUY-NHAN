    ...
    <div className="container px-4 py-8 md:px-6 md:py-12">
      <div className="flex flex-col gap-8">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-gray-500">Kiểm tra sản phẩm trước khi đặt hàng</p>
        </div>

        {cart.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            <ShoppingCart className="h-16 w-16 text-gray-300 mb-4" />
            <h3 className="text-lg font-medium">Giỏ hàng đang trống</h3>
            <p className="text-gray-500 mt-1 mb-6">Bạn chưa thêm sản phẩm nào vào giỏ hàng.</p>
            <Link href="/products">
            ...
            <div className="lg:col-span-1">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Kiểm tra chi tiết đơn hàng</CardDescription>
                </CardHeader>
                <CardContent>
